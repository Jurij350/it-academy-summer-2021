# Напишите программу, которая считает общую цену. Вводится М рублей и N копеек.цена, а также количество S товара.
...
print("\rTotal amound: " + str(price_finish // 100) + " rubles " + str(price_finish % 100) + " kopeсks. ")
